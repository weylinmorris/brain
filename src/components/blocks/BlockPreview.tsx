...
function BlockPreview({ block, onClick, showPreview = true, showTime = true }: BlockPreviewProps) {
    return (
        <div
            className="cursor-pointer space-y-2 rounded-md bg-neutral-50 px-4 py-2 text-neutral-500 hover:bg-neutral-100 hover:text-neutral-600 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-500 dark:hover:text-neutral-50 md:bg-neutral-100 md:dark:bg-neutral-600"
